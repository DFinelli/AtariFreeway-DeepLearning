...
parser = argparse.ArgumentParser(description="Train and test different networks")
...
parser.add_argument("-v", "--view", action='store_true', help="Display the network playing a game. Is overriden by the -s command", required=False)

args = parser.parse_args()
print(args)

game_instance = Freeway(args.network)
